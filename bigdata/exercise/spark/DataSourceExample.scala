...
import sql.DataFrameSQLExample.sparkSession
...
//        runParquetSchemaMergingExample(spark)
  ...
  private def runBasicDataSourceExample(spark: SparkSession): Unit = {
    ...
    peopleDF.select("name", "age").write.format("parquet").save("src/main/resources/namesAndAges.parquet")
    ...
    private def runBasicParquetExample(spark: SparkSession): Unit = {
      ...
      val peopleDF = spark.read.json("src/main/resources/output/resources/people.json")
